...
impl Popup for WriteErrorPopup {
    ...
    fn render(&mut self, frame: &mut Frame, area: Rect) {
        ...
        let title = Paragraph::new("error occured while writing fstab to path: ".to_owned() + &self.path).style(Style::new().bold().red()).centered();
